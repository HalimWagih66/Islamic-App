...
class _DisplayBookMarkState extends State<DisplayBookMark> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () async {
        await quranDetailsViewModel.saveBookMark(page: quranDetailsViewModel.pageVerses[0].pageInSurah!.toInt(), surahNumber: quranDetailsViewModel.informationAboutTheSurahModel.number!.toInt());
      },
      child: Padding(
  ...
  Widget getBookMark() {
    ...
    if(bookMark?[PAGE_NUMBER_KEY] == quranDetailsViewModel.pageVerses[0].pageInSurah?.toInt() && bookMark?[SURAH_NUMBER_KEY] == quranDetailsViewModel.informationAboutTheSurahModel.number?.toInt()){
