          ...
          children: [
            Expanded(
              child: ElevatedButton(
                  ...
                  child: Align(alignment: Alignment.centerRight,child: Text(title,style:tasbeehTapViewModel.themeApp.font25ThirdColorRegularInter,textAlign: TextAlign.right,))
              ),
            ),
